			...
			<fieldset class="reset-this redo-fieldset">
				...
				<div class="form-group row ms-5">
					<label for="inputUserName"
						class="col-sm-2 col-form-label mt-2 mb-2">Username</label>
					<div class="col-sm-8">
				...
				<div class="form-group row ms-5">
					<label for="inputPassword"
						class="col-sm-2 col-form-label mt-2 mb-2 ">Password</label>
					<div class="col-sm-8">
						<input type="password" class="form-control mb-2 mr-5 mt-2"
				...
				<div class="footer">
					<input type="button" class="btn btn-secondary btn-lg"
						value="Signup" onclick="window.location='signup.jsp'">
